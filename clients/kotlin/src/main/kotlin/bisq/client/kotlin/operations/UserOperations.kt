...
class UserOperations(basePath: kotlin.String = defaultBasePath, client: OkHttpClient = ApiClient.defaultClient) : ApiClient(basePath, client) {
    companion object {
        @JvmStatic
    ...
    fun create(createRequest: CreateRequest) : kotlin.Any {
        val localVarResponse = createWithHttpInfo(createRequest = createRequest)
    ...
    fun createWithHttpInfo(createRequest: CreateRequest) : ApiResponse<kotlin.Any?> {
        val localVariableConfig = createRequestConfig(createRequest = createRequest)

        return request<CreateRequest, kotlin.Any>(
            localVariableConfig
        )
    }
     ...
     */
    fun createRequestConfig(createRequest: CreateRequest) : RequestConfig<CreateRequest> {
